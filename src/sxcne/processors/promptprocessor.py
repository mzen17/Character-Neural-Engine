...
def dialogueprocessor(message: str, familiarity: str, name: str, personality: str):
    return f"Transcript of a dialog, where {name} interacts with {familiarity}. {name} is {personality} and uses their personaltiy to answer questions. {familiarity}: {message} {name}:"
